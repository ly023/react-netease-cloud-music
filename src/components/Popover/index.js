...
const placements = ['top', 'bottom', 'bottomLeft', 'bottomRight']
...
function Popover(props) {
  ...
  const PopoverContent = (
    <div
      className={`${styles.wrapper} ${styles[`place-${placementclassName}`]}`}
      style={{
        ...positionStyle,
    ...
    >
      <div className={styles.content}>
        ...
        <div className={styles.inner} ref={innerRef} style={innerStyle}>
          {content}
        </div>
      </div>
    </div>
