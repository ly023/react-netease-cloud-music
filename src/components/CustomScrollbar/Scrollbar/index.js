...
export default class Scrollbar extends Component {
    ...
    _update(callback) {
        ...
        const values = this.getViewValues()
        ...
        if (getScrollbarWidth()) {
            ...
            const thumbHorizontalX = overflowWidth ? (scrollLeft / (scrollWidth - clientWidth) * (trackHorizontalWidth - thumbHorizontalWidth)) : 0
            ...
            const thumbVerticalY = overflowHeight ? (scrollTop / (scrollHeight - clientHeight) * (trackVerticalHeight - thumbVerticalHeight)) : 0
